...
<body>
	...
	header("Content-Disposition: attachment; filename=Riwayat Transaksi Mingguan.xls");
	?>
 
	<center>
		<h1>Laporan Mingguan <br/> Rumah Singgah</h1>
	</center>
	...
	<table border="2">
		...
		$date = date("y-m-d");
                        	 $sql = mysqli_query($conn,"SELECT * FROM selesai  WHERE YEARWEEK(tanggal) = YEARWEEK(CURDATE())");
