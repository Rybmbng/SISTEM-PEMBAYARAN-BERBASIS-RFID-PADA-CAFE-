...
<html lang="en">
  <head>
   <?php include_once 'template_kasir/style.php' ?>
  </head>
  <body>
    <div class="container-scroller"> 
      <?php include_once 'template_kasir/navbar.php'; ?>
      <div class="container-fluid page-body-wrapper">
        <?php include_once 'template_kasir/sidebar.php'; ?>
        <div class="main-panel">
          <div class="content-wrapper">
          <?php include './controller/pagekasir.php'; ?>
          </div>
          <footer class="footer">
