			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table table-striped">
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td><a href="?admin=detail_transaksi&id=<?php echo $data['kd_transaksi'] ?>"><?php echo ucwords($fetch['nama_lengkap']) ?></a></td>
						...
						<?php 
						if($data['status'] == 'diproses'){
							echo "<a class='badge bg-danger' href='?admin=dimasak&id=$data[username]'>Masak</a>";
						}else if($data['status'] == 'dimasak'){
							echo "<a class='badge bg-info' href='?admin=diantar&id=$data[username]'>Antar</a>";
						}else{
