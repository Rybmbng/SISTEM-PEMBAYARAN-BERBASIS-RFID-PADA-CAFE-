              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5">Rp. <?php echo $sum['totals'] ?></h2>                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                      ...
                      <table class="table">
                        ...
                        ?>
                          <tr>
                            ...
                            <td> <a href="?kasir=detail&id=<?php echo $data['kd_transaksi'] ?>" style="text-decoration:none;"><?php echo $data['kd_transaksi']?> </a> </td>
                            <td>
