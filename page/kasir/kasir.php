...
<main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="?kasir=">Home</a></li>
					...
					<div class="table-wrap">
                        ...
                        ?>
						    <tr>
						      ...
						      <td><a href="?kasir=detail&id=<?php echo $data['kd_transaksi'] ?>"><?php echo ucwords($fetch['nama_lengkap']) ?></a></td>
						...
						<?php 
						if($data['status'] == 'dipesan'){
                          echo "<a class='badge bg-info' href='?kasir=diproses&id=$data[username]'>Terima</a>";
                        }else if($data['status'] == 'dinikmati'){
							echo "<a class='badge bg-info' href='?kasir=detail&id=$data[kd_transaksi]'>Bayar</a>";
						  }else{
