...
<main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="?koki=">Home</a></li>
				...
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table table-striped">
						  ...
						  <tbody>
                          	<?php
                        	 $sql = mysqli_query($conn,"SELECT * FROM transaksi WHERE status='diproses' OR status='dimasak'");
						    ...
						    <tr>
						      ...
						      <td><a href="?koki=detail_transaksi&id=<?php echo $data['kd_transaksi'] ?>"><?php echo ucwords($fetch['nama_lengkap']) ?></a></td>
						...
						<?php 
						if($data['status'] == 'diproses'){
							echo "<a class='badge bg-danger' href='?koki=dimasak&id=$data[username]'>Masak</a>";
						}else if($data['status'] == 'dimasak'){
							echo "<a class='badge bg-info' href='?koki=diantar&id=$data[username]'>Antar</a>";
						}else{
